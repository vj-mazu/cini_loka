    ...
    <section id="amenities" className="py-24 md:py-32 bg-bg relative overflow-hidden border-t border-white/5">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        >
          ...
          <h2 className="text-4xl md:text-8xl lg:text-9xl font-display italic text-white tracking-tighter leading-[1.1]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
          {amenities.map((item, index) => (
            <motion.div
              ...
              className="flex items-start gap-4 md:gap-6 p-6 md:p-12 rounded-3xl md:rounded-[2.5rem] glass hover:bg-white/[0.06] transition-all duration-700 group relative overflow-hidden"
            >
              ...
              <div className="flex flex-col gap-2 md:gap-3">
                <h3 className="text-xl md:text-3xl font-display italic text-white tracking-tight leading-tight group-hover:text-accent-light transition-colors">
                  {item.title}
                </h3>
                <p className="text-text-secondary text-xs md:text-sm leading-relaxed font-light opacity-60 group-hover:opacity-100 transition-opacity">
                  {item.desc}
                </p>
              </div>
