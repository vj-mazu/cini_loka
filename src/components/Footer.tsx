  ...
  return (
    <footer className="relative bg-bg pt-24 pb-16 overflow-hidden border-t border-white/5">
      ...
      <div className="relative z-10">
        ...
        <div className="overflow-hidden whitespace-nowrap mb-16 md:mb-32 opacity-20">
          <div ref={marqueeRef} className="inline-block">
            {Array(10).fill("").map((_, i) => (
              <span key={i} className="text-6xl md:text-[15rem] font-display italic gold-gradient tracking-tighter uppercase px-8 md:px-20 select-none leading-none opacity-50">
                CINI LOKA • RAICHUR • 
              </span>
            ))}
          </div>
        ...
        {/* Contact CTA */}
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 text-center mb-24 md:mb-48">
          <motion.div
          ...
          >
            <h2 className="text-4xl sm:text-6xl md:text-9xl lg:text-[11rem] font-display text-text-primary leading-[1.1] tracking-tighter mb-12 md:mb-20 select-none">
              Let's craft <span className="italic gold-gradient">magic</span> together
            </h2>

            {/* Quick action buttons */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16 md:mb-20">
              <a
                href="https://wa.me/917483343412"
                target="_blank"
                rel="noopener noreferrer"
                className="group flex flex-col items-center gap-4 glass p-6 md:p-8 rounded-[2.5rem] hover:bg-[#25D366]/10 transition-all duration-500"
              >
              ...
              <a
                ...
                className="group flex flex-col items-center gap-4 glass p-6 md:p-8 rounded-[2.5rem] hover:bg-white/5 transition-all duration-500"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex flex-col items-center gap-4 glass p-6 md:p-8 rounded-[2.5rem] hover:bg-white/5 transition-all duration-500 lg:col-span-1"
              >
                <div className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center text-white text-xl">📍</div>
            ...
            <a
              ...
              onClick={copyEmail}
              className="group relative flex flex-col sm:flex-row items-center justify-between gap-8 px-6 md:px-16 py-8 md:py-12 rounded-[2.5rem] md:rounded-[3rem] glass hover:bg-white/[0.08] transition-all duration-700 shadow-2xl cursor-pointer z-10 w-full max-w-2xl mx-auto"
            >
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 border-t border-white/5 pt-16 mb-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-left text-text-secondary/70">
            ...
            <div>
              ...
              <p className="text-base font-light">10:00 AM – 11:00 PM<br />Seven days a week</p>
            </div>
            <div>
