      ...
      >
        ...
        <div className="flex items-center gap-0.5 md:gap-1">
          {[
            ...
            <a
              key={link.name}
              href={link.href}
              className={`px-2 md:px-4 py-2.5 md:py-3 text-[10px] md:text-[13px] rounded-full transition-all duration-300 font-bold uppercase tracking-[0.1em] md:tracking-[0.2em] text-white/50 hover:text-white hover:bg-white/5 ${
        ...
        <div className="flex items-center gap-1.5 md:gap-2 pr-1 md:pr-2">
          ...
          <a
            ...
            className="flex relative group px-2 md:px-6 py-2.5 md:py-3.5 text-[11px] md:text-xs rounded-full font-bold uppercase tracking-[0.15em] transition-all text-text-primary/70 hover:text-white hover:bg-white/5 min-h-[44px] items-center"
          >
          ...
          <Magnetic>
            <a
              ...
              className="relative group px-3 md:px-8 py-2.5 md:py-3.5 rounded-full overflow-hidden transition-all duration-500 shadow-lg shadow-accent/10 flex-shrink-0 min-h-[44px] flex items-center justify-center"
            >
