        ...
        <div className="flex items-center gap-1">
          {[
            ...
            <a
              key={link.name}
              href={link.href}
              className="px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm rounded-full transition-colors font-medium text-muted hover:text-text-primary hover:bg-white/5"
            >
              {link.name}
            </a>
          ))}
