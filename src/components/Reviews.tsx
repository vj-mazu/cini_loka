      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 relative z-10">
        ...
        >
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="flex flex-col items-center gap-4 glass-dark p-6 md:p-12 rounded-[2.5rem] md:rounded-[3.5rem] border border-accent/20 shadow-[0_0_50px_rgba(226,194,133,0.1)] hover:shadow-accent/20 transition-all duration-1000 group relative"
          >
            ...
            <span className="text-5xl md:text-8xl font-display italic gold-gradient leading-none relative z-10">
              4.8
            </span>
            <div className="relative z-10">
              <StarRating rating={5} />
            </div>
            <span className="text-[10px] text-accent tracking-[0.3em] md:tracking-[0.5em] uppercase font-bold mt-2 opacity-80 relative z-10">
              Google Verified
            </span>
          </motion.div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {REVIEWS.map((review, idx) => (
            <motion.div
              ...
              className="group glass rounded-3xl md:rounded-[2.8rem] p-6 md:p-12 transition-all duration-700 hover:bg-white/[0.08]"
            >
