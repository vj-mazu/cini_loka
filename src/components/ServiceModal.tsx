          ...
          >
            ...
            <div className="flex-1 p-6 md:p-8 lg:p-12 overflow-hidden h-full">
              <div className="h-full flex flex-col md:flex-row gap-8 lg:gap-12">
                ...
                <button
                  onClick={onClose}
                  className="absolute top-6 right-6 md:top-8 md:right-8 w-10 h-10 rounded-full bg-black/60 backdrop-blur-md border border-white/10 hover:bg-white/10 flex items-center justify-center text-white transition-all transform hover:rotate-90 z-[120]"
                >
                  ✕
                </button>
              </div>
