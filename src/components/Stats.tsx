  ...
  return (
    <section id="stats" className="bg-bg py-12 md:py-32 border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-12 md:gap-24 text-center">
          {STATS.map((stat, idx) => (
            <motion.div
              key={idx}
            ...
            >
              ...
              <div className="flex flex-col gap-6 relative">
                ...
                <span className="text-4xl sm:text-6xl md:text-8xl lg:text-[10rem] font-display italic gold-gradient tracking-tight group-hover:scale-105 transition-transform duration-1000 select-none relative z-10 px-2 sm:px-4">
                  {stat.value.includes('+') ? (
                ...
                <span className="text-[10px] md:text-xs text-text-secondary uppercase tracking-[0.2em] md:tracking-[0.6em] font-bold group-hover:text-white group-hover:tracking-[0.8em] transition-all duration-700 relative z-10">
                  {stat.label}
                </span>
              </div>
